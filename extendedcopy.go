...
type ExtendedCopyGraphOptions struct {
	...
	FindPredecessors func(ctx context.Context, src content.ImmutableGraphStorage, desc ocispec.Descriptor) ([]ocispec.Descriptor, error)
}
...
func ExtendedCopy(ctx context.Context, src ImmutableGraphTarget, srcRef string, dst Target, dstRef string, opts ExtendedCopyOptions) (ocispec.Descriptor, error) {
	if src == nil {
...
func ExtendedCopyGraph(ctx context.Context, src content.ImmutableGraphStorage, dst content.Storage, node ocispec.Descriptor, opts ExtendedCopyGraphOptions) error {
...
// depth-first search.
func findRoots(ctx context.Context, storage content.ImmutableGraphStorage, node ocispec.Descriptor, opts ExtendedCopyGraphOptions) (map[descriptor.Descriptor]ocispec.Descriptor, error) {
	...
	if opts.FindPredecessors == nil {
		opts.FindPredecessors = func(ctx context.Context, src content.ImmutableGraphStorage, desc ocispec.Descriptor) ([]ocispec.Descriptor, error) {
