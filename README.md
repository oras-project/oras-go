...
- Install from the latest [release artifacts](https://github.com/oras-project/oras-go/releases):

  - Linux

    ```sh
    curl -LO https://github.com/oras-project/oras-go/releases/download/v0.11.1/oras_0.11.1_linux_amd64.tar.gz
  ...
  - macOS
    ...
    ```sh
    curl -LO https://github.com/oras-project/oras-go/releases/download/v0.11.1/oras_0.11.1_darwin_amd64.tar.gz
    mkdir -p oras-install/
    tar -zxf oras_0.11.1_*.tar.gz -C oras-install/
    mv oras-install/oras /usr/local/bin/
    rm -rf oras_0.11.1_*.tar.gz oras-install/
  ...
  - Windows
    ...
    ```sh
    curl.exe -sLO  https://github.com/oras-project/oras-go/releases/download/v0.11.1/oras_0.11.1_windows_amd64.tar.gz
  ...
  - Docker Image
    ...
    ```sh
    docker run -it --rm -v $(pwd):/workspace ghcr.io/oras-project/oras-go:v0.11.1 help
    ```
...
> See: [Issue 130](https://github.com/oras-project/oras-go/issues/130) for eliminating `-a` and `--media-type`
