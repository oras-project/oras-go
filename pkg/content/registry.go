...
// NewRegistryWithDiscover creates a new registry with the discovery feature
func NewRegistryWithDiscover(targetRef string, opts RegistryOptions) (target.Target, error) {
