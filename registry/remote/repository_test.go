		...
		{
			{
				...
				Annotations: map[string]string{
					"io.cncf.oras.artifact.created": "2019-10-12T09:20:50.52Z",
				},
			},
			{
				MediaType:    artifactspec.MediaTypeArtifactManifest,
				...
				ArtifactType: "application/vnd.test",
				Annotations: map[string]string{
					"io.cncf.oras.artifact.created": "2019-10-12T08:20:50.52Z",
				},
			},
		},
		{
...
func TestRepository_Referrers_InvalidOrder(t *testing.T) {
	manifest := []byte(`{"layers":[]}`)
	manifestDesc := ocispec.Descriptor{
		MediaType: ocispec.MediaTypeImageManifest,
		Digest:    digest.FromBytes(manifest),
		...
		{
			{
				...
				ArtifactType: "application/vnd.test",
				Annotations: map[string]string{
					"io.cncf.oras.artifact.created": "2019-10-12T07:20:50.52Z",
				},
			},
			{
				MediaType:    artifactspec.MediaTypeArtifactManifest,
		...
		{
			{
				...
				ArtifactType: "application/vnd.test",
				Annotations: map[string]string{
					"io.cncf.oras.artifact.created": "2019-10-12T08:21:50.52Z",
				},
			},
		},
	}
	...
	if err := repo.Referrers(ctx, manifestDesc, "", func(got []artifactspec.Descriptor) error {
		...
		t.Errorf("Repository.Referrers() invalid order not captured: %v", err)
	}
}
