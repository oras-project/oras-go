...
func TestClient_Do_Bearer_AccessToken_Cached_PerHost(t *testing.T) {
	...
	service1 = uri1.Host
	client1 := &Client{
		CredentialFunc: credentials.StaticCredentialFunc(uri1.Host, properties.Credential{
	...
	service2 = uri2.Host
	client2 := &Client{
		CredentialFunc: credentials.StaticCredentialFunc(uri2.Host, properties.Credential{
	...
	client1.CredentialFunc = credentials.StaticCredentialFunc(uri1.Host, properties.Credential{
		AccessToken: accessToken1,
	})
	resp1, err = client1.Do(req1)
	if err != nil {
	...
	client2.CredentialFunc = credentials.StaticCredentialFunc(uri2.Host, properties.Credential{
		AccessToken: accessToken2,
	})
	resp2, err = client2.Do(req2)
	if err != nil {
...
func TestClient_StaticCredential_basicAuth(t *testing.T) {
	...
	clientValid := &Client{
		CredentialFunc: credentials.StaticCredentialFunc(hostAddress, properties.Credential{
