...
func SelectManifest(ctx context.Context, src content.ReadOnlyStorage, root ocispec.Descriptor, p *ocispec.Platform) (ocispec.Descriptor, error) {
	...
	case docker.MediaTypeManifestList, ocispec.MediaTypeImageIndex:
		...
		return ocispec.Descriptor{}, fmt.Errorf("%s: no matching manifest was found in the manifest list", root.Digest)
	case docker.MediaTypeManifest, ocispec.MediaTypeImageManifest:
		...
		return ocispec.Descriptor{}, fmt.Errorf("%s: platform in manifest does not match target platform", root.Digest)
	default:
